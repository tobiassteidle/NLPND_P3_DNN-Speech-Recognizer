...
def rnn_model(input_dim, units, activation, output_dim=29):
    ...
    bn_rnn = BatchNormalization(name='bn_simp_rnn_1d')(simp_rnn)
...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    # TODO: Add a TimeDistributed(Dense(output_dim))
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    for layer in range(recur_layers):
        rnn = Bidirectional(GRU(units, return_sequences=True, implementation=2))(rnn_data)
        
        # Add batch normalization to bidirectional rnn layer        
        bnn = BatchNormalization()(rnn)
        
        # Add dropout
        rnn_data = Dropout(0.3)(bnn)
